      ...
      <div className="container mx-auto px-5 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 text-xs">
          <Link href="/my-plan" className="flex items-center gap-1.5">
            ...
            <span className="bg-lime-400 text-black font-bold rounded-full w-5 h-5 flex items-center justify-center">
              {plan.length}
            </span>
          </Link>
          <Link href="/my-plan" className="flex items-center gap-1.5">
            <span className="text-gray-500">Saved</span>
            <span className="bg-white text-black font-bold rounded-full w-5 h-5 flex items-center justify-center">
              {saved.length}
            </span>
          </Link>
        </div>
